...
import storeUsHome from "../assets/MacBook Air - 1 (1).png";
...
const Home = () => {
  ...
  return (
    <>
    <div className="relative  bg-opacity-40 overflow-hidden">
  <main
className="relative z-10">

    <section className=" relative w-full px-4 py-12 sm:py-[104px]">
  
        <div className="flex relative z-10  max-w-7xl mx-auto flex-row justify-between  ">
  ...
  <AnimatePresence mode="wait">
    ...
    >
      {slides[currentIndex].title.map((line, idx) => (
        <p key={idx} className={idx === 1 ? "text-[#DCCDA5]" : "text-black"}>
          {line}
        </p>
      ))}
    </motion.div>
...
<AnimatePresence mode="wait">
  ...
  >
    ...
    <div className="mt-8">
      <a
        href="#contact"
        className="inline-block bg-[#DCCDA5] hover:bg-[#DCCDA5] text-white font-semibold px-6 py-2 rounded-full transition"
      >
        تواصل معنا
      </a>
    </div>
      ...
      {/* Cards Section */}
      <div dir="rtl" className="px-4 relative sm:px-6 lg:px-8 py-6  font-sans">
          ...
          {cards.map((card) => (
            <button
              ...
              className={`group p-4 sm:p-6 rounded-2xl shadow-md sm:shadow-xl border border-gray-200 cursor-pointer transition-all duration-300
                bg-white hover:bg-blue-50 focus:text-white focus:bg-[#DCCDA5] active:bg-[#DCCDA5] active:text-white
                focus:outline-none`}
            >
      ...
      {/* <BackgroundCircles position="top-left" /> */}
        <div className="flex relative z-10 flex-col max-w-7xl mx-auto lg:flex-row min-h-[50vh]  ">
           {/* Text Content */}
...
{/* Expansion Cards Section */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto gap-4 sm:gap-6">
        {expansionCards.map((card) => (
          ...
          >
<div className="absolute top-0 left-0 w-full h-8  bg-[#DCCDA5] rounded-t-2xl  text-center flex items-center justify-center  text-white" > {card.period}</div>
        ...
        <div className="flex flex-col lg:flex-row   ">
          ...
          <div className="w-full lg:w-1/2 h-auto lg:h-full flex items-center justify-center ">
            <img
              src={storeUsHome}
              alt="وصف الصورة"
              className="w-full h-auto ml-[-25%] lg:max-h-none object-contain lg:object-cover"
            />
          </div>
  ...
  <div className="text-center mt-10">
    <button className="bg-[#DCCDA5] hover:bg-[#DCCDA5] text-white font-semibold px-6 py-2 rounded-full transition">
      اقراء المزيد
    </button>
  </div>
</div>
